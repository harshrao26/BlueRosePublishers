...
const Contact = () => {
  return (
    <div>
      <div>
        <div class="mx-auto max-w-7l -4 bg-zinc-100">
          <div class="mx-auto max-w-7xl py-12 md:py-12">
            <div class="grid items-center justify-items-center gap-x-4 gap-y-10 lg:grid-cols-2">
              <div class="flex items-center justify-center">
                <div class="px-2 md:px-12">
                  <p class="text-2xl font-bold text-zinc-900 md:text-4xl">
                    Get in touch
                  </p>
                  ...
                  <form action="" class="mt-8 space-y-4">
                    <div class="grid w-full gap-y-4 md:gap-x-4 lg:grid-cols-2">
                      <div class="grid w-full  items-center gap-1.5">
                        <label
                          class="text-sm font-medium leading-none text-zinc-700 peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                          for="first_name"
                        >
                          First Name
                        </label>
                        <input
                          class="flex h-10 w-full rounded-md border border-zinc-300 bg-transparent px-3 py-2 text-sm placeholder:text-zinc-400 focus:outline-none focus:ring-1 focus:ring-zinc-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 dark:border-zinc-700 dark:text-zinc-50 dark:focus:ring-zinc-400 dark:focus:ring-offset-zinc-900"
                          type="text"
                          id="first_name"
          ...
          <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div class="py-20">
              <div class="grid grid-cols-1 gap-x-20 gap-y-8 lg:grid-cols-2">
                <div class="space-y-4">
                  <p class="w-full text-4xl font-bold text-zinc-900">
                    Our Offices
                  </p>
                  <p class="w-full text-lg text-zinc-600">
                    Find us at these locations.
                  </p>
                </div>
                <div class="space-y-4 divide-y-2">
                  <div class="flex flex-col space-y-2 pt-4 first:pt-0 lg:w-full">
                    <p class="w-full text-xl font-semibold  text-zinc-900">
                      Bengaluru office
                    </p>
                    <p class="w-full text-base  text-zinc-600">
                      Mon-Sat 9am to 5pm.
                    </p>
