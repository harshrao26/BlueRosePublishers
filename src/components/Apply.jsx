...
const Apply = () => {
  ...
  return (
    <>
      <div
        className={`flex md:px-16 px-8 bg-zinc-900 items-center justify-between fixed bottom-0 w-full z-[100000] py-2 transition-all ease-in-out duration-500 transform ${
