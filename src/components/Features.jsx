  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row w-full gap-8 md:px-16 py- px-4">
        ...
        <div className="md:w-1/3 w-full  rounded md:mt-10 hover:scale-105 transition-all ease-in-out hover:bg-gray-100  flex flex-col items-center justify-around p-8 shadow-xl text-center">
          <IoMdBarcode className="text-black mb-4" size={60} />
          <p className="text-black text-base leading-5 text-justify">
        ...
        <div className="md:w-1/3 w-full rounded mb-10 md:mb-10 hover:scale-105 transition-all ease-in-out  shadow-xl hover:bg-white bg-zinc-100 flex flex-col items-center justify-around p-8 text-center">
