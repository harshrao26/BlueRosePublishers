...
const Hero = () => {
  return (
    <div
      className="w-full py-20 md:py-40 flex flex-col items-center justify-center px-4 md:px-0 bg-cover bg-center"
      style={{
        backgroundImage:
    ...
    >
      <div className="backdrop-blur-md py-8 px-4 rounded-xl">
